 ...
 * pzfx-parser - parser
 * @version v0.0.0
 * @link https://github.com/cheminfo/pzfx-parser#readme
 * @license MIT
 */
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pzfxParser = {}));
	      ...
	      if (Array.isArray(table[i].YColumn)) {
	        for (let j = 0; j < table[i].YColumn.length; j++) {
	          y.push({
	            ...
	            data: Array.isArray(table[i].YColumn[j].Subcolumn) ? table[i].YColumn[j].Subcolumn.map(x => x.d) : table[i].YColumn[j].Subcolumn.d
	          });
	        }
	        ...
	        y.push({
	          ...
	          data: Array.isArray(table[i].YColumn.Subcolumn) ? table[i].YColumn.Subcolumn.map(x => x.d) : table[i].YColumn.Subcolumn.d
	        });
	        element.y = y;
	      }
	    ...
	    if (Array.isArray(table.YColumn)) {
	      for (let j = 0; j < table.YColumn.length; j++) {
	        y.push({
	          ...
	          data: Array.isArray(table.YColumn[j].Subcolumn) ? table.YColumn[j].Subcolumn.map(x => x.d) : table.YColumn[j].Subcolumn.d
	        });
	      }
	    } else {
	      y.push({
	        label: checkLabel(table.YColumn.Title),
	        data: Array.isArray(table.YColumn.Subcolumn) ? table.YColumn.Subcolumn.map(x => x.d) : table.YColumn.Subcolumn.d
	      });
	    }
	...
	exports.pzfxParser = pzfxParser;

	Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=pzfx-parser.js.map
